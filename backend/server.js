...
app.use(cors({
    origin: ["http://localhost:3000", "https://chatconnect-in5b.onrender.com"], // Allow requests only from this origin
...
const io = require("socket.io")(server,{
    pingTimeout : 60000,
    cors:{
        origin: ["http://localhost:3000", "https://chatconnect-in5b.onrender.com"],
    },
});
